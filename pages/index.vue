<template>
  <div class="app">
    <div class="row" style="margin: 0px auto;" justify="center" align="center">
...
-->
    ...
    >
      ...
      <div class="container-fluid" align="center" justify="center" style="margin-top: 15px;">
        <div class="col">
          <AppButton
...
export default {
  ...
  data () {
    return {
      ...
      item: {
        title: null,
        descrition: 'ลงชื่อเพื่อ ร่วมเป็น 1 ในผู้สถาปนา ในวันวิสาขบูชาโลก ออนไลน์ ครั้งที่1',
        coverImage: null,
        url: 'https://master.d1xnc86zjtxdwi.amplifyapp.com/'
      },
      blog: null,
      user: {
        displayName: '',
